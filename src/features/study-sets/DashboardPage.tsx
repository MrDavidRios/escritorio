...
export function DashboardPage() {
  ...
  return (
    <div className="bg-wood flex-1">
      <div className="mx-auto flex max-w-3xl flex-col gap-4 p-4 pt-14">
        <div className="flex items-center justify-between">
          <h1 className="text-wood-ink text-xl font-bold">Your study sets</h1>
        ...
        {isError && (
          <div className="border-destructive/30 bg-card flex flex-col items-start gap-2 rounded-lg border p-4">
        ...
        {studySets && studySets.length === 0 && (
          <p className="bg-card text-muted-foreground rounded-lg border p-4">
